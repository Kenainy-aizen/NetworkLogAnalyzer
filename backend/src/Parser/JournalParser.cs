...
public class JournalParser : ILogParser
{
    ...
    public NetworkEvent? Parse(RawLogLine rawLine)
    {
        ...
        {
            networkEvent.SourceIp = IpNormalizer.Normalize(sshFailed.Groups["ip"].Value);
        ...
        {
            networkEvent.SourceIp = IpNormalizer.Normalize(sshInvalid.Groups["ip"].Value);
        ...
        {
            networkEvent.SourceIp = IpNormalizer.Normalize(sshAccepted.Groups["ip"].Value);
